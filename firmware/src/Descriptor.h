...
typedef struct {
	...
	USB_Descriptor_Endpoint_t  HID_ReportOUTEndpoint; // Host send command to us, like calibration data
...
#define GAMEPAD_OUT_EPADDR   (ENDPOINT_DIR_OUT | 2)

#define GAMEPAD_IN_EPSIZE       16
#define GAMEPAD_OUT_EPSIZE      8 
